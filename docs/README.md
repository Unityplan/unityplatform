...
Welcome to the Unity Platform documentation. This guide will help you navigate the documentation structure and find the information you need.
...
Start here to understand what Unity Platform is and its core purpose.

- **[Summary](project/summary.md)** - Executive overview of the Unity Platform
