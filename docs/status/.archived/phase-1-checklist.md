...
☐ Create environment configuration
  ...
  └─ .env.production
     VITE_API_URL=https://api.unityplatform.org
     VITE_WS_URL=wss://api.unityplatform.org
...
☐ Add Matrix Synapse to docker-compose.yml
  ...
  matrix-synapse:
    ...
    environment:
      - SYNAPSE_SERVER_NAME=${TERRITORY_CODE}.unityplatform.org
...
☐ Register users on Matrix when they register on platform
  ...
  └─ Generate Matrix user ID (@username:territory.unityplatform.org)
