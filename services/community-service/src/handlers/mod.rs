...
use community::{
    ...
    get_group_summary, get_hierarchy, get_managed_communities, get_membership,
    get_root_communities, join_community, leave_community, list_communities,
    list_communities_paginated, list_requirements, remove_requirement, revoke_manager,
    update_community,
};
...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg
        ...
        .service(
            web::resource("/{id}/effective-requirements")
                .route(web::get().to(get_effective_requirements)),
        )
        ...
        .service(
            web::resource("/{id}/requirements/{badge_id}")
                .route(web::delete().to(remove_requirement)),
        );
}
